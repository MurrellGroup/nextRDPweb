  ...
  const startScan = async () => {
    ...
    try {
      ...
      setProgress((current) => ({
        ...
        phase: "complete",
        fraction: 1,
        processedTriplets: value.processedTriplets,
        totalTriplets: value.totalTriplets,
        correctionTests: value.correctionTests,
        activeWorkingSequenceCount: value.activeWorkingSequenceCount,
        queryWorkingSequenceCount: value.queryWorkingSequenceCount,
        referenceWorkingSequenceCount: value.referenceWorkingSequenceCount,
        activeReferenceGroupCount: value.activeReferenceGroupCount,
        cumulativeTriplets: value.cumulativeTriplets,
        scanRound: value.scanRounds,
        maximumDetectionCycles: value.maximumDetectionCycles,
        fixedEventCount: value.events.length,
        signalCount: value.signals.length,
        eventCount: value.events.length,
        maxChiProfilesScanned: value.maxChiProfilesScanned,
        maxChiPeakAttempts: value.maxChiPeakAttempts,
        maxChiCandidatesFound: value.maxChiCandidatesFound,
        maxChiPeakLimitTriplets: value.maxChiPeakLimitTriplets,
        chimaeraProfilesScanned: value.chimaeraProfilesScanned,
        chimaeraPeakAttempts: value.chimaeraPeakAttempts,
        chimaeraCandidatesFound: value.chimaeraCandidatesFound,
        chimaeraPeakLimitTargets: value.chimaeraPeakLimitTargets,
        geneconvFragmentsScored: value.geneconvFragmentsScored,
        geneconvQualifiedFragments: value.geneconvQualifiedFragments,
        geneconvCandidatesFound: value.geneconvCandidatesFound,
        geneconvOverlapRejections: value.geneconvOverlapRejections,
        geneconvNumericalFallbackTracks: value.geneconvNumericalFallbackTracks,
        threeSeqProfilesScanned: value.threeSeqProfilesScanned,
        threeSeqExactEvaluations: value.threeSeqExactEvaluations,
        threeSeqApproximateEvaluations: value.threeSeqApproximateEvaluations,
        threeSeqCandidatesFound: value.threeSeqCandidatesFound,
        bootscanProfilesScanned: value.bootscanProfilesScanned,
        bootscanCandidateRegionsScored: value.bootscanCandidateRegionsScored,
        bootscanCandidatesFound: value.bootscanCandidatesFound,
        bootscanPairProfilesRequested: value.bootscanPairProfilesRequested,
        bootscanPairProfileCacheHits: value.bootscanPairProfileCacheHits,
        bootscanPairProfileCacheMisses: value.bootscanPairProfileCacheMisses,
        bootscanPairProfileCacheEvictions: value.bootscanPairProfileCacheEvictions,
        bootscanPairProfileCachePeakBytes: value.bootscanPairProfileCachePeakBytes,
        siscanProfilesScanned: value.siscanProfilesScanned,
        siscanWindowsScored: value.siscanWindowsScored,
        siscanCandidateRegionsScored: value.siscanCandidateRegionsScored,
        siscanCandidatesFound: value.siscanCandidatesFound,
        siscanPermutationDraws: value.siscanPermutationDraws,
        siscanContextBuilds: value.siscanContextBuilds,
        siscanContextPairComparisons: value.siscanContextPairComparisons,
        siscanContextTreeMerges: value.siscanContextTreeMerges,
        siscanRandomValuesGenerated: value.siscanRandomValuesGenerated,
        cycleTermination: value.cycleTermination,
        timing: value.timing,
