...
function makeSourceFaithfulResults(
  ...
  const events = raw.events.map((rawEvent): ReconciledEvent => {
    ...
    const event = {
      ...
      anchorMethod: "RDP",
      detectionMethods: ["RDP"],
      maxChiChimaeraOnlySupport: false,
      detectionRound: 1,
